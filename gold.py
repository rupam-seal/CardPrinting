...
class Gold:
    ...
    def set_value(self):
        ...
        # gold value
        gold_value = Draw(self.obj.entry10, background_front, 600, 2000, color_text,  font_text, 90)
        gold_value.adding_text_with_unit("%")

        # silver value
        silver_value = Draw(self.obj.entry11, background_front, 600, 2170, color_text,  font_text, 90)
        silver_value.adding_text_with_unit("%")

        # copper value
        copper_value = Draw(self.obj.entry12, background_front, 1670, 2000, color_text,  font_text, 90)
        copper_value.adding_text_with_unit("%")

        # other value
        other_value = Draw(self.obj.entry13, background_front, 1670, 2170, color_text,  font_text, 90)
